...
export const WINDOWS_SETTINGS_PAGES: WindowsSettingsPage[] = [
  ...
  { title: "Notifications", uri: "ms-settings:notifications", keywords: ["notification settings", "alerts"] },
  {
    title: "Focus assist",
    uri: "ms-settings:quiethours",
    keywords: ["focus", "do not disturb", "quiet hours"],
  },
  { title: "Power & sleep", uri: "ms-settings:powersleep", keywords: ["power", "battery", "sleep settings"] },
  ...
  { title: "Printers & scanners", uri: "ms-settings:printers", keywords: ["printer", "scanner", "printing"] },
  {
  ...
  { title: "Date & time", uri: "ms-settings:dateandtime", keywords: ["clock", "time zone", "date settings"] },
  {
  ...
  { title: "Privacy & security", uri: "ms-settings:privacy", keywords: ["privacy settings", "permissions"] },
  {
...
export function searchWindowsSettings(query: string): PaletteItem[] {
  ...
  return (exactTitleMatches.length > 0 ? exactTitleMatches : ranked)
    ...
    .map(({ page }) => ({
      ...
      icon: { kind: "tile", icon: Settings, tint: "azure" },
